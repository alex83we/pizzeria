                        ...
                        <div class="container">
                            ...
                            @foreach($category as $key => $kategorie)
                                <div class="speisekarte__mahlzeiten-gruppe" id="{{ $kategorie->slug }}" anchor-id="{{ $kategorie->slug }}">
                                    <div class="speisekarte__mahlzeiten-gruppe-kategorie">
                                        <div class="speisekarte__kategorie-bilder-container" data-src="{{ url('images/kategorie/'.$kategorie->images) }}" style="background-image: url('{{ url('images/kategorie/'.$kategorie->images) }}')"></div>
